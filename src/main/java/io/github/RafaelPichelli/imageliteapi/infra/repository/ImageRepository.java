...
import static io.github.RafaelPichelli.imageliteapi.infra.repository.specs.GenericSpecs.*;
import static io.github.RafaelPichelli.imageliteapi.infra.repository.specs.ImageSpecs.*;
import static org.springframework.data.jpa.domain.Specification.anyOf;
import static org.springframework.data.jpa.domain.Specification.where;

public interface ImageRepository extends JpaRepository<Image, String>, JpaSpecificationExecutor<Image> {

    default List<Image> findByExtensionAndAndNameOrTagsLike(ImageExtension extension, String query){
